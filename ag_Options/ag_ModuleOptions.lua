		...
		function aUF.Options.ModOnRegisterOptions.Healthbar()
			local config = {
				...
				args = {
                    ...
                    GradientHealth = {
                        name = "Gradient Healthbar",
						type = "toggle",
						desc = "Color the healthbar by unit health percentage.",
						set = optionSet,
						arg = -3,
						get = get,
                    },
                    PrimaryStatColorBars = {
                        name = "Color By Primary Stat",
						type = "toggle",
						desc = "Color the healthbar by unit primary stat.",
						set = optionSet,
						arg = -3,
						get = get,
                    }
